...
// local modules
const { BINANCE_APP, TIME, BASE_UNIT, ASSET_UNIT, REQUEST_TIMEOUT, ALERT, TRADE_TYPE, PAY_TYPES } = require('./config');
...
const REQUEST_BODY = { "page": 1, "rows": 10, transAmount: `${ALERT.limit.amount}`, "asset": ASSET_UNIT, "tradeType": TRADE_TYPE, "payTypes": PAY_TYPES, "fiat": BASE_UNIT, "publisherType": null, "merchantCheck": false };
const BINANCE_P2P_BUY_URL = `https://p2p.binance.com/en/trade/${TRADE_TYPE}/${ASSET_UNIT}?fiat=${BASE_UNIT}`;
